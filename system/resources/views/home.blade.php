...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="dashboard">PASLINE</a>
    ...
    <section class="ftco-section">
		...
		<section class="ftco-section img" style="background-image: url(public/assets/images/bg_3.jpg);">
    	<div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to Pasline can't be removed. Template is licensed under CC BY 3.0. -->
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://pasline.com" target="_blank">Pasline</a>

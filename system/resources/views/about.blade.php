...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(public/assets/images/about.jpg);">
      ...
      <div class="container py-4">
		...
		<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(public/assets/images/bg_3.jpg);">
    	<div class="container">
